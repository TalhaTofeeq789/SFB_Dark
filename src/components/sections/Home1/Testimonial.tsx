                ...
                <div className="sec-title">
                  <div className="row">
                    <div className="col-xxl-6 col-xl-7 col-lg-8">
                      <span className="sub-title"><img className="icon-img" src="assets/images/icons/sub-title-shape.png" alt="" />Social Proof</span>
                      <h2 className="title">Real results from <br />real <span className="color1">businesses</span></h2>
                    </div>
                    <div className="col-xxl-5 col-xl-5 col-lg-4 offset-xxl-1">
                      <p className="text">Don't just take our word for it. Here's what our clients say about working with SFB Marketing.</p>
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-4">
                    <div className="review-box">
                      ...
                      <div className="text">Based on successful campaigns and client satisfaction.</div>
                    </div>
                  </div>
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="testimonial-block">
                            <div className="inner-box">
                              ...
                              <p className="text">"We brought in SFB to help find new sales reps, and within a few weeks, we had three closers already making us revenue."</p>
                              <div className="info-box">
                                <div className="user-thumb">
                                  <img className="user" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Founder" />
                                </div>
                                <div className="user-info">
                                  <h4 className="name">Founder</h4>
                                  <span className="designation">Blacksmith Ltd</span>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="testimonial-block">
                            <div className="inner-box">
                              ...
                              <p className="text">"Our Instagram was dead. They brought it back to life with content that actually connects."</p>
                              <div className="info-box">
                                <div className="user-thumb">
                                  <img className="user" src="https://images.unsplash.com/photo-1494790108755-2616b612b436?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Brand Owner" />
                                </div>
                                <div className="user-info">
                                  <div className="user">
                                    <h4 className="name">Khaadi Brand Owner</h4>
                                    <span className="designation">E-commerce</span>
                                  </div>
                                </div>
                              </div>
                            </div>
